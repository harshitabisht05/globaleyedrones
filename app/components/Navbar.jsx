...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 shadow-sm font-body transition-colors duration-300">
